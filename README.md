...
Telegram-бот для учёта личных финансов на aiogram 3 + SQLAlchemy 2.0 async. Записи через текст без кнопок, история за любой период, графики по категориям, накопления и учёт активов/пассивов. 175 тестов, модульная архитектура.
