...
Telegram-бот для учёта личных финансов на aiogram 3 + SQLAlchemy 2.0 async. Записи через текст без кнопок, история за любой период, графики по категориям, бюджеты по категориям, накопления и учёт активов/пассивов, финансовые цели, долги и займы, экспорт/импорт в Excel, авторассылки сводок и напоминаний, совместный семейный бюджет. 554 теста, модульная архитектура.
