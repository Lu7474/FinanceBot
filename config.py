...
MAX_DEBT_AMOUNT = 10_000_000       # Макс. сумма одного долга
MAX_DEBT_PERSON_NAME = 100         # Макс. длина имени должника/кредитора
MAX_PAYMENT_AMOUNT = 10_000_000    # Макс. сумма платежа-напоминания
MAX_PAYMENT_TITLE = 100            # Макс. длина названия платежа
